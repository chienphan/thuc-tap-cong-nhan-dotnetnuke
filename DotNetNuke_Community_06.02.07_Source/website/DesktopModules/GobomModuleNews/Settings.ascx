<%@ Control Language="C#" AutoEventWireup="false" Inherits="GobomDNN.Modules.GobomModuleNews.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="GobomModuleNews Settings Design Table">
    <tr>
